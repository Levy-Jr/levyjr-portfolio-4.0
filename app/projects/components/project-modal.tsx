...
const ProjectModal = ({ index, setProjectIndex }: { index: number, setProjectIndex: React.Dispatch<React.SetStateAction<number | undefined>> }) => {
  ...
  return (
    <div className="fixed pt-[6.25rem] inset-0 bg-black/30 backdrop-blur-md">
      <div ref={menuRef} className="absolute z-50 right-1/2 translate-x-1/2 w-[min(62.5rem,100%)] rounded-[.625rem] flex flex-col overflow-hidden bg-white dark:bg-[#1B1B1B] border border-darkGray">
